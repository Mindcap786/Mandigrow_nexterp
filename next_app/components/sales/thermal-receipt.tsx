...
import { FONT_FAMILIES, FONT_URLS } from "@/components/local-invoices/utils/fonts"
...
const fontFamily = activeLang === 'en' ? 'monospace' : FONT_FAMILIES[activeLang];
const fontUrl = activeLang !== 'en' ? FONT_URLS[activeLang] : null;
...
return (
<div className="bg-white text-black text-[30px] leading-snug w-full font-bold pb-8" style={{ filter: 'grayscale(100%) contrast(1000%)', maxWidth: '100%', padding: '0 8px', fontFamily }}>
