            ...
            <div className="flex flex-col md:flex-row gap-4 items-start border-b-4 border-black pb-3 mb-3 relative z-10 print:flex print:flex-row print:w-full print:justify-between">
                ...
                <div className="self-center flex flex-col items-center text-center md:flex-none print:flex-none">
                    <h2 data-invoice-title className="text-2xl md:text-3xl font-black uppercase tracking-[0.28em] leading-[1.08] text-black text-center" style={{ fontFamily }}>
                        {(T as any).PURCHASE_BILL || 'PURCHASE BILL'}
                    </h2>
                ...
                <table className="w-full text-left">
                    <thead className="print:table-header-group">
                        <tr className="border-b-2 border-black break-inside-avoid print:break-inside-avoid">
                            <th className="py-2 text-[10px] font-black uppercase tracking-[0.2em] text-black text-left" style={{ fontFamily }}>{(T as any).ITEM_DETAILS || 'Item Details'}</th>
                            <th className="py-2 text-[10px] font-black uppercase tracking-[0.2em] text-black text-left">HSN</th>
                            <th className="py-2 text-[10px] font-black uppercase tracking-[0.2em] text-black text-center" style={{ fontFamily }}>{T.QTY || 'Qty'}</th>
                            <th className="py-2 text-[10px] font-black uppercase tracking-[0.2em] text-black text-right" style={{ fontFamily }}>{T.RATE || 'Rate'}</th>
                            <th className="py-2 text-[10px] font-black uppercase tracking-[0.2em] text-black text-right" style={{ fontFamily }}>{T.AMT || 'Amount'}</th>
                        </tr>
                    </thead>
            ...
            <div className="mt-6 flex flex-col md:flex-row gap-8 items-start relative z-10 print:flex print:flex-row print:gap-4 print:mt-4 print:break-inside-avoid w-full">
                ...
                <div className="space-y-6 w-full md:w-1/2 print:w-[48%]">
                    <div className="space-y-1.5 border-t-2 border-black pt-4">
                        ...
                        {combinedPaid > 0 && (
                            <div className="flex justify-between items-center text-xs border-t border-gray-100 pt-1">
                                <span className="text-emerald-600 font-bold uppercase tracking-widest" style={{ fontFamily }}>{(T as any).AMOUNT_PAID || T.AMOUNT_RECEIVED || 'Amount Paid'}</span>
                        ...
                        <div className="text-right mt-3">
                            <p className="text-xs font-black text-slate-900 italic uppercase leading-tight">
                                Rupees {amountInWords(Math.round(finalPayable), lang)}
                            </p>
                        </div>
                    </div>
                </div>
