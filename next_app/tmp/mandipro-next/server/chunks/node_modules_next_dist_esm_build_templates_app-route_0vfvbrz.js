...
`}],b="https://www.mandigrow.com";function T(){let e=new Date,a=v.map(e=>({url:`${b}/blog/${e.slug}`,lastModified:new Date(e.publishedAt),changeFrequency:"monthly",priority:.7}));return[{url:`${b}/`,lastModified:e,changeFrequency:"weekly",priority:1},{url:`${b}/mandi-billing`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/commission-agent-software`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/mandi-khata-software`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/wholesale-trader-erp`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/gst-mandi-compliance`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/sabzi-mandi-software`,lastModified:e,changeFrequency:"monthly",priority:.9},{url:`${b}/faq`,lastModified:e,changeFrequency:"monthly",priority:.7},{url:`${b}/blog`,lastModified:e,changeFrequency:"weekly",priority:.8},...a,{url:`${b}/subscribe`,lastModified:e,changeFrequency:"monthly",priority:.8},{url:`${b}/contact`,lastModified:e,changeFrequency:"monthly",priority:.5}]}e.s(["default",0,T],89282);var M=e.i(973853);async function R(){let e=await T(),a=(0,M.resolveRouteData)(e,"sitemap");return new w.NextResponse(a,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}e.s(["GET",0,R],539248),e.i(539248),e.i(89282),e.s(["GET",0,R],921330);var A=e.i(921330);let P=new a.AppRouteRouteModule({definition:{kind:t.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:"/tmp/mandipro-next",relativeProjectDir:"",resolvedPagePath:"[project]/app/sitemap--route-entry.js",nextConfigOutput:"",userland:A,...{}}),{workAsyncStorage:k,workUnitAsyncStorage:E,serverHooks:C}=P;async function G(e,a,i){i.requestMeta&&(0,o.setRequestMeta)(e,i.requestMeta),P.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let w="/sitemap.xml/route";w=w.replace(/\/index$/,"")||"/";let v=await P.prepare(e,a,{srcPage:w,multiZoneDraftMode:!1});if(!v)return a.statusCode=400,a.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:b,params:T,nextConfig:M,parsedUrl:R,isDraftMode:A,prerenderManifest:k,routerServerContext:E,isOnDemandRevalidate:C,revalidateOnlyGenerated:G,resolvedPathname:S,clientReferenceManifest:x,serverActionsManifest:I}=v,N=(0,s.normalizeAppPath)(w),q=!!(k.dynamicRoutes[N]||k.routes[S]),H=async()=>((null==E?void 0:E.render404)?await E.render404(e,a,R,!1):a.end("This page could not be found"),null);if(q&&!A){let e=!!k.routes[S],a=k.dynamicRoutes[N];if(a&&!1===a.fallback&&!e){if(M.adapterPath)return await H();throw new f.NoFallbackError}}let F=null;!q||P.isDev||A||(F="/index"===(F=S)?"/":F);let W=!0===P.isDev||!q,O=q&&!W;I&&x&&(0,n.setManifestsSingleton)({page:w,clientReferenceManifest:x,serverActionsManifest:I});let D=e.method||"GET",$=(0,r.getTracer)(),_=$.getActiveScopeSpan(),B=!!(null==E?void 0:E.isWrappedByNextServer),U=!!(0,o.getRequestMeta)(e,"minimalMode"),L=(0,o.getRequestMeta)(e,"incrementalCache")||await P.getIncrementalCache(e,M,k,U);null==L||L.resetRequestCache(),globalThis.__incrementalCache=L;let j={params:T,previewProps:k.preview,renderOpts:{experimental:{authInterrupts:!!M.experimental.authInterrupts},cacheComponents:!!M.cacheComponents,supportsDynamicResponse:W,incrementalCache:L,cacheLifeProfiles:M.cacheLife,waitUntil:i.waitUntil,onClose:e=>{a.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(a,t,i,o)=>P.onRequestError(e,a,i,o,E)},sharedContext:{buildId:b}},K=new l.NodeNextRequest(e),Y=new l.NodeNextResponse(a),z=d.NextRequestAdapter.fromNodeNextRequest(K,(0,d.signalFromNodeResponse)(a));try{let o,n=async e=>P.handle(z,j).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":a.statusCode,"next.rsc":!1});let t=$.getRootSpanAttributes();if(!t)return;if(t.get("next.span_type")!==u.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${t.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=t.get("next.route");if(i){let a=`${D} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":a}),e.updateName(a),o&&o!==e&&(o.setAttribute("http.route",i),o.updateName(a))}else e.updateName(`${D} ${w}`)}),s=async o=>{var r,s;let l=async({previousCacheEntry:t})=>{try{if(!U&&C&&G&&!t)return a.statusCode=404,a.setHeader("x-nextjs-cache","REVALIDATED"),a.end("This page could not be found"),null;let r=await n(o);e.fetchMetrics=j.renderOpts.fetchMetrics;let s=j.renderOpts.pendingWaitUntil;s&&i.waitUntil&&(i.waitUntil(s),s=void 0);let l=j.renderOpts.collectedTags;if(!q)return await (0,h.sendResponse)(K,Y,r,j.renderOpts.pendingWaitUntil),null;{let e=await r.blob(),a=(0,m.toNodeOutgoingHttpHeaders)(r.headers);l&&(a[g.NEXT_CACHE_TAGS_HEADER]=l),!a["content-type"]&&e.type&&(a["content-type"]=e.type);let t=void 0!==j.renderOpts.collectedRevalidate&&!(j.renderOpts.collectedRevalidate>=g.INFINITE_CACHE)&&j.renderOpts.collectedRevalidate,i=void 0===j.renderOpts.collectedExpire||j.renderOpts.collectedExpire>=g.INFINITE_CACHE?void 0:j.renderOpts.collectedExpire;return{value:{kind:y.CachedRouteKind.APP_ROUTE,status:r.status,body:Buffer.from(await e.arrayBuffer()),headers:a},cacheControl:{revalidate:t,expire:i}}}}catch(a){throw(null==t?void 0:t.isStale)&&await P.onRequestError(e,a,{routerKind:"App Router",routePath:w,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:C})},!1,E),a}},d=await P.handleResponse({req:e,nextConfig:M,cacheKey:F,routeKind:t.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:k,isRoutePPREnabled:!1,isOnDemandRevalidate:C,revalidateOnlyGenerated:G,responseGenerator:l,waitUntil:i.waitUntil,isMinimalMode:U});if(!q)return null;if((null==d||null==(r=d.value)?void 0:r.kind)!==y.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(s=d.value)?void 0:s.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});U||a.setHeader("x-nextjs-cache",C?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),A&&a.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let u=(0,m.fromNodeOutgoingHttpHeaders)(d.value.headers);return U&&q||u.delete(g.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||a.getHeader("Cache-Control")||u.get("Cache-Control")||u.set("Cache-Control",(0,p.getCacheControlHeader)(d.cacheControl)),await (0,h.sendResponse)(K,Y,new Response(d.value.body,{headers:u,status:d.value.status||200})),null};B&&_?await s(_):(o=$.getActiveScopeSpan(),await $.withPropagatedContext(e.headers,()=>$.trace(u.BaseServerSpan.handleRequest,{spanName:`${D} ${w}`,kind:r.SpanKind.SERVER,attributes:{"http.method":D,"http.target":e.url}},s),void 0,!B))}catch(a){if(a instanceof f.NoFallbackError||await P.onRequestError(e,a,{routerKind:"App Router",routePath:N,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:C})},!1,E),q)throw a;return await (0,h.sendResponse)(K,Y,new Response(null,{status:500})),null}}e.s(["handler",0,G,"patchFetch",0,function(){return(0,i.patchFetch)({workAsyncStorage:k,workUnitAsyncStorage:E})},"routeModule",0,P,"serverHooks",0,C,"workAsyncStorage",0,k,"workUnitAsyncStorage",0,E],8922)}];
