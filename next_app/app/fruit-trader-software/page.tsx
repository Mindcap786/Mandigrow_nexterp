...
export const metadata: Metadata = {
    title: 'Fruit Trader Software — ERP & Billing for Fruit Mandis | MandiGrow',
    description: 'Complete fruit trader software for Indian mandis. Manage fruit lots, crate inventory, purchase bills, sales invoices, and GST for any fruit variety.',
    keywords: [
    ...
    alternates: { canonical: 'https://www.mandigrow.com/fruit-trader-software' },
    openGraph: {
        title: 'Fruit Trader Software — ERP & Billing for Fruit Mandis | MandiGrow',
        description: 'Complete fruit trader software for Indian mandis. Manage fruit lots, crate inventory, purchase bills, sales invoices, and GST for any fruit variety.',
        url: 'https://www.mandigrow.com/fruit-trader-software',
        type: 'website',
    },
};

export default function FruitTraderSoftwarePage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Fruit Trader Software', item: 'https://www.mandigrow.com/fruit-trader-software' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Fruit Traders · Crate Tracking · GST Ready
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: 'Best Software for <span className="text-emerald-700">Fruit Traders</span>' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow is the ultimate ERP and billing software for fruit wholesale traders. Track perishable inventory, manage crate deposits, generate GST invoices, and maintain live party ledgers.
                </p>
