...
export const metadata: Metadata = {
    title: 'Mandi Inventory Management Software — Lot & Crate Tracking | MandiGrow',
    description: 'Advanced inventory management for agricultural traders. Track produce by lot, manage crate returns, and monitor stock aging.',
    keywords: [
        'mandi inventory software',
        'crate tracking software',
        'lot management software',
        'agricultural stock tracking'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/inventory-management-mandi' },
    openGraph: {
        title: 'Mandi Inventory Management Software — Lot & Crate Tracking | MandiGrow',
        description: 'Advanced inventory management for agricultural traders. Track produce by lot, manage crate returns, and monitor stock aging.',
        url: 'https://www.mandigrow.com/inventory-management-mandi',
        type: 'website',
    },
};

export default function InventoryManagementMandiPage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Mandi Inventory Management Software', item: 'https://www.mandigrow.com/inventory-management-mandi' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Inventory · Lot Tracking · Crate Management
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: '<span className="text-emerald-700">Inventory Management</span> for Mandis' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow provides granular control over your mandi inventory. Track every lot of produce from arrival to sale, manage empty crate deposits/returns, and monitor stock aging to prevent wastage.
                </p>
