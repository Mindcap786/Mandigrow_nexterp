...
export const metadata: Metadata = {
    title: 'Ghazipur Mandi Software — APMC ERP for Delhi Traders | MandiGrow',
    description:
        'MandiGrow is the premier software for Ghazipur Mandi, Delhi. Manage commission agent billing, poultry & vegetable ledgers, and APMC compliance with ease.',
    keywords: [
        'Ghazipur mandi software',
        'APMC Ghazipur software',
        'Ghazipur APMC ERP',
        'commission agent software Ghazipur',
        'poultry mandi software Delhi',
        'vegetable market software Ghazipur',
    ],
    alternates: { canonical: 'https://www.mandigrow.com/ghazipur-mandi-software' },
    openGraph: {
        title: 'Ghazipur Mandi Software — MandiGrow APMC ERP',
        description: 'Best APMC and commission agent software for Ghazipur Mandi traders. Handles daily volume & complex accounting seamlessly.',
...
const FEATURES = [
    { title: 'Vegetable & Poultry Ready', desc: 'Customizable units and commission structures for both the vegetable market and the specialized poultry/meat trade at Ghazipur.' },
    ...
    { title: 'Ghazipur APMC Compliant', desc: 'Generates gate passes and APMC levy reports automatically, saving hours of manual data entry.' },
];
        ...
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Ghazipur Mandi Software', item: 'https://www.mandigrow.com/ghazipur-mandi-software' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Delhi · Hindi Supported · APMC Ghazipur
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]">
                    Built for the Scale of <span className="text-emerald-700">Ghazipur Mandi</span>
                </h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow is the #1 APMC ERP and commission agent software for Ghazipur Mandi, Delhi. Whether you operate in the vegetable market or the poultry market, our cloud software automates commission calculation, farmer ledger (Khata), APMC levy reporting, and GST billing.
                </p>
            ...
            <section className="bg-emerald-900 text-white py-12 px-6">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-emerald-200">During peak hours in Ghazipur, an Arhtiya processes hundreds of bills an hour. MandiGrow's shortcut-driven interface allows your accountants to punch bills at lightning speed, while the system automatically calculates deductions like hamali, palledari, and commission.</p>
                    </div>
                </div>
            </section>

            <section className="max-w-5xl mx-auto px-6 py-16">
                <h2 className="text-4xl font-black tracking-tighter text-gray-900 mb-4">Why Ghazipur Traders Choose MandiGrow</h2>
                <p className="text-lg text-gray-600 mb-10">We understand the unique complexities of Delhi's massive wholesale agricultural and poultry market:</p>
            ...
            <section className="max-w-3xl mx-auto px-6 pb-24 text-center">
                <div className="bg-emerald-700 text-white rounded-3xl p-10">
                    <h2 className="text-3xl font-black tracking-tighter mb-4">Digitize Your Ghazipur Commission Agency</h2>
