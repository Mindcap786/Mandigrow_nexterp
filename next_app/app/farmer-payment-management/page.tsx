...
export const metadata: Metadata = {
    title: 'Farmer Payment Management Software — Mandi Settlements | MandiGrow',
    description: 'Automate farmer payments and settlements. MandiGrow computes net payables after commission, freight, and APMC charges instantly.',
    keywords: [
        'farmer payment software',
        'mandi settlement software',
        'farmer ledger software',
        'agricultural payments India'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/farmer-payment-management' },
    openGraph: {
        title: 'Farmer Payment Management Software — Mandi Settlements | MandiGrow',
        description: 'Automate farmer payments and settlements. MandiGrow computes net payables after commission, freight, and APMC charges instantly.',
        url: 'https://www.mandigrow.com/farmer-payment-management',
        type: 'website',
    },
};

export default function FarmerPaymentManagementPage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Farmer Payment Management Software', item: 'https://www.mandigrow.com/farmer-payment-management' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Farmer Settlements · Auto-Calculation
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: '<span className="text-emerald-700">Farmer Payment</span> Management' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    Ensure 100% accuracy in farmer settlements. MandiGrow automatically calculates the net amount payable to farmers by deducting commission, hamali, APMC fee, and advances from the gross sale.
                </p>
