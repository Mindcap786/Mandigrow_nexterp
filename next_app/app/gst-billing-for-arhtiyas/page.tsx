...
export const metadata: Metadata = {
    title: 'GST Billing Software for Arhtiyas — Mandi Commission Agents | MandiGrow',
    description: 'GST billing software built specifically for arhtiyas and mandi commission agents. Seamlessly generate B2B invoices and file GSTR-1 & 3B.',
    keywords: [
        'GST billing for arhtiyas',
        'commission agent GST software',
        'mandi GST billing',
        'APMC GST software'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/gst-billing-for-arhtiyas' },
    openGraph: {
        title: 'GST Billing Software for Arhtiyas — Mandi Commission Agents | MandiGrow',
        description: 'GST billing software built specifically for arhtiyas and mandi commission agents. Seamlessly generate B2B invoices and file GSTR-1 & 3B.',
        url: 'https://www.mandigrow.com/gst-billing-for-arhtiyas',
        type: 'website',
    },
};

export default function GstBillingForArhtiyasPage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'GST Billing Software for Arhtiyas', item: 'https://www.mandigrow.com/gst-billing-for-arhtiyas' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Arhtiyas · GST Compliant · E-Invoicing Ready
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: '<span className="text-emerald-700">GST Billing</span> for Arhtiyas' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow simplifies GST compliance for Arhtiyas. Generate GST-compliant invoices for B2B and B2C sales directly from auction entries. Export data effortlessly for GSTR-1 and GSTR-3B filing.
                </p>
