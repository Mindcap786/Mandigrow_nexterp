...
export const metadata: Metadata = {
    title: 'Mandi Warehouse Management Software — Cold Storage & Godowns | MandiGrow',
    description: 'Warehouse management software tailored for mandis and cold storage. Track inventory by lot, calculate storage rent, and manage dispatch for agricultural produce.',
    keywords: [
        'mandi warehouse software',
        'cold storage software',
        'agricultural inventory management',
        'godown software India'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/warehouse-management-mandi' },
    openGraph: {
        title: 'Mandi Warehouse Management Software — Cold Storage & Godowns | MandiGrow',
        description: 'Warehouse management software tailored for mandis and cold storage. Track inventory by lot, calculate storage rent, and manage dispatch for agricultural produce.',
        url: 'https://www.mandigrow.com/warehouse-management-mandi',
        type: 'website',
    },
};

export default function WarehouseManagementMandiPage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Mandi Warehouse Management Software', item: 'https://www.mandigrow.com/warehouse-management-mandi' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Warehouse & Cold Storage · Lot Tracking
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: 'Best <span className="text-emerald-700">Warehouse Management</span> for Mandis' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    Manage your agricultural cold storage and mandi godowns efficiently with MandiGrow. Track stock by lot, age, and farmer. Automatically compute storage rent and manage secure dispatches.
                </p>
