...
export default function MasterCratePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-amber-50/20 p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-slate-500 text-sm ml-13">Master Data — Add crate types, set rates, track inventory</p>
                </div>
