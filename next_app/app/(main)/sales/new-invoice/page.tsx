...
import NewInvoiceForm from "@/components/sales/new-invoice-form";
...
export default function NewInvoicePage() {
    ...
    const titleText = t('nav.bulk_lot_sale') || "Bulk Lot Sale";
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-400 font-bold tracking-tight uppercase text-[9px] mt-0.5 flex items-center gap-2">
                        ...
                        {t('sales.bulk_lot_sale_subtitle') || "Normal sale process for bulk buyers at once"}
                    </p>
                </div>
            </div>
