            ...
            <div className="max-w-7xl mx-auto space-y-6 md:space-y-10 pb-20">
                ...
                {loading && !stats ? (
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                            ...
                            <div className="group bg-white p-6 md:p-10 rounded-2xl md:rounded-[40px] border border-slate-200 shadow-sm flex flex-col justify-between gap-4 md:gap-6 overflow-hidden relative">
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    {/* Write-off / Settlements: buyer balance forgiven */}
                                    {(stats?.totalWriteoff || 0) > 0 && (
                                        <div className="flex justify-between items-baseline">
                                            <p className="text-[10px] font-black text-violet-500 uppercase tracking-widest flex items-center gap-1">
                                                <TrendingDown className="w-3 h-3" /> Less: Write-off / Settlements
                                            </p>
                        ...
                        {/* Buyer Collections / Pass-through Fees */}
                        {(stats?.totalSaleRecoveries || 0) > 0 && (
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 lg:gap-10 mt-6 md:mt-10">
