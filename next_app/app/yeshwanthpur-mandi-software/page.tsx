...
export const metadata: Metadata = {
    title: 'Yeshwanthpur Mandi Software — APMC ERP for Bangalore | MandiGrow',
    description:
        'MandiGrow is the #1 software for APMC Yeshwanthpur, Bangalore. Manage commission agent billing, farmer khata, APMC levy, and onion/potato trade efficiently. Kannada supported.',
    keywords: [
        'Yeshwanthpur mandi software',
        'APMC Yeshwanthpur software',
        'Yeshwanthpur APMC ERP',
        'commission agent software Bangalore',
        'mandi billing software Yeshwanthpur',
        'Bangalore wholesale market software',
    ],
    alternates: { canonical: 'https://www.mandigrow.com/yeshwanthpur-mandi-software' },
    openGraph: {
        title: 'Yeshwanthpur Mandi Software — MandiGrow APMC ERP',
        description: 'Best APMC and commission agent software for Yeshwanthpur Mandi traders. Handles massive volume & daily accounting seamlessly.',
...
const FEATURES = [
    { title: 'Multi-Commodity Support', desc: 'From the massive Onion & Potato market to fresh fruits, configure separate commission rules and APMC levies for each commodity.' },
    ...
    { title: 'Yeshwanthpur APMC Compliant', desc: 'Generates gate passes and APMC levy reports automatically, saving hours of manual data entry.' },
];
        ...
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Yeshwanthpur Mandi Software', item: 'https://www.mandigrow.com/yeshwanthpur-mandi-software' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Bangalore · Kannada & Hindi Supported · APMC Yeshwanthpur
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]">
                    Built for the Scale of <span className="text-emerald-700">APMC Yeshwanthpur</span>
                </h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow is the #1 APMC ERP and commission agent software for Yeshwanthpur Mandi, Bangalore. From the bustling Onion & Potato market to the Fruit market, our cloud software automates commission calculation, farmer ledger (Khata), APMC levy reporting, and GST billing.
                </p>
            ...
            <section className="bg-emerald-900 text-white py-12 px-6">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-emerald-200">During peak hours in Yeshwanthpur, an Arhtiya processes hundreds of bills an hour. MandiGrow's shortcut-driven interface allows your accountants to punch bills at lightning speed, while the system automatically calculates deductions like hamali, palledari, and commission.</p>
                    </div>
                </div>
            </section>

            <section className="max-w-5xl mx-auto px-6 py-16">
                <h2 className="text-4xl font-black tracking-tighter text-gray-900 mb-4">Why Yeshwanthpur Traders Choose MandiGrow</h2>
                <p className="text-lg text-gray-600 mb-10">We understand the unique complexities of Bangalore's largest wholesale agricultural market:</p>
            ...
            <section className="max-w-3xl mx-auto px-6 pb-24 text-center">
                <div className="bg-emerald-700 text-white rounded-3xl p-10">
                    <h2 className="text-3xl font-black tracking-tighter mb-4">Digitize Your Yeshwanthpur Commission Agency</h2>
                    <p className="text-emerald-100 mb-6">14 days free. Demo in Kannada, Hindi, or English. No credit card required.</p>
