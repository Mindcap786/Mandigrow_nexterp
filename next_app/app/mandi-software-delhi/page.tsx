...
export const metadata: Metadata = {
    title: 'Mandi Software Delhi — APMC ERP for Azadpur Mandi Traders | MandiGrow',
    description: 'MandiGrow is the best mandi software for Delhi. Complete APMC billing, commission agent software, and farmer ledger for Azadpur Mandi, Okhla, and Ghazipur.',
    keywords: [
        'mandi software Delhi',
        'APMC software Delhi',
        'Azadpur mandi software',
        'commission agent software Delhi',
        'arhtiya software Delhi'
    ],
        ...
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Mandi Software Delhi', item: 'https://www.mandigrow.com/mandi-software-delhi' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Delhi · Hindi Supported · APMC Ready
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: 'Best Mandi Software for <span className="text-emerald-700">Delhi</span>' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow is the #1 APMC and commission agent software for Delhi. Engineered for the massive scale of Azadpur Mandi, handling auto commission, farmer ledgers, and GST billing.
                </p>
