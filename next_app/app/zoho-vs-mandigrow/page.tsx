...
export const metadata: Metadata = {
    title: 'Zoho Books vs MandiGrow | The Best APMC Commission Agent Software',
    description: 'Compare Zoho Books with MandiGrow for Mandi Commission Agents. Discover why MandiGrow handles lot tracking, APMC levies, and farmer ledger (Khata) much better.',
    keywords: [
        'Zoho vs MandiGrow',
        'Zoho Books for Mandi',
        'Zoho for commission agent',
        'Zoho alternative for Mandi',
        'sabji mandi software vs zoho',
        'APMC billing zoho'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/zoho-vs-mandigrow' },
};

const COMPARISONS = [
    { feature: 'Commission (Arhtiya) Workflow', zoho: 'Missing natively', mandigrow: 'Built-in auto deduction' },
    { feature: 'APMC Market Fee Calculation', zoho: 'No native APMC support', mandigrow: 'Auto-calculates state-specific Mandi Levy' },
    { feature: 'Multi-Unit Billing (Boxes to Kgs)', zoho: 'Manual unit conversions', mandigrow: 'Native box/lot to Kg conversion' },
    { feature: 'Farmer Advance Tracking', zoho: 'General ledger only', mandigrow: 'Dedicated farmer Khata with advance recovery' },
    { feature: 'Crate Tracking Ledger', zoho: 'Handled via inventory hacks', mandigrow: 'Native Crate Ledger parallel to cash' },
    { feature: 'High-Volume Speed', zoho: 'Standard accounting speed', mandigrow: 'Keyboard-shortcut optimized for morning rush' }
];

export default function ZohoVsMandiGrowPage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Zoho vs MandiGrow', item: 'https://www.mandigrow.com/zoho-vs-mandigrow' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center">
                ...
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]">
                    Zoho vs <span className="text-emerald-700">MandiGrow</span>
                </h1>
            ...
            <section className="max-w-5xl mx-auto px-6 py-12">
                <div className="bg-white border border-emerald-100 rounded-3xl overflow-hidden shadow-sm">
                    <div className="grid grid-cols-3 bg-emerald-50 p-4 border-b border-emerald-100 font-bold text-emerald-900">
                        <div>Feature</div>
                        <div className="text-gray-500">Zoho Books</div>
                    ...
                    {COMPARISONS.map((row, i) => (
                        <div key={i} className="grid grid-cols-3 p-4 border-b border-gray-100 items-center">
                            ...
                            <div className="text-gray-500 text-sm pr-4">❌ {row.zoho}</div>
