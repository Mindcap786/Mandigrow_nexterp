...
export const metadata: Metadata = {
    title: 'Vegetable Market Software — Sabji Mandi Billing App | MandiGrow',
    description: 'Top vegetable market software and sabzi mandi billing app. Quick entry for vegetable auctions, auto-calculate weights, and print pattis in seconds.',
    keywords: [
        'vegetable market software',
        'sabji mandi billing app',
        'sabzi mandi software',
        'vegetable wholesale software India'
    ],
    alternates: { canonical: 'https://www.mandigrow.com/vegetable-market-software' },
    openGraph: {
        title: 'Vegetable Market Software — Sabji Mandi Billing App | MandiGrow',
        description: 'Top vegetable market software and sabzi mandi billing app. Quick entry for vegetable auctions, auto-calculate weights, and print pattis in seconds.',
        url: 'https://www.mandigrow.com/vegetable-market-software',
        type: 'website',
    },
};

export default function VegetableMarketSoftwarePage() {
    return (
        <main className="min-h-screen bg-[#f7fbf3] text-gray-900">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                ...
                itemListElement: [
                    ...
                    { '@type': 'ListItem', position: 2, name: 'Vegetable Market Software', item: 'https://www.mandigrow.com/vegetable-market-software' },
                ],
            }) }} />
            ...
            <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
                <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black uppercase tracking-wider mb-6">
                    Vegetable Markets · Quick Entry · APMC Ready
                </div>
                <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-gray-900 mb-6 leading-[1.05]" dangerouslySetInnerHTML={{ __html: 'Best Software for <span className="text-emerald-700">Vegetable Markets</span>' }}></h1>
                <p className="text-xl text-gray-600 max-w-3xl mb-8 font-medium leading-relaxed">
                    MandiGrow speeds up your morning auction with quick-entry vegetable billing. Auto-calculate commissions, market fees, and hamali on the fly for any sabji variety.
                </p>
