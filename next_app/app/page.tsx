...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#dce7c8] text-gray-900 selection:bg-emerald-600 selection:text-white font-sans overflow-x-hidden">
            ...
            {/* Footer */}
            <footer className="border-t border-[#c8d6b0] pt-16 pb-8 px-6 bg-[#dce7c8] relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                        ...
                        <div className="flex gap-x-8 gap-y-4 text-sm font-bold text-emerald-800/80 flex-wrap justify-center md:justify-end max-w-2xl">
                            ...
                            <Link href="/privacy" className="hover:text-emerald-950 hover:underline decoration-emerald-500/30 underline-offset-4 transition-all">{t('landing.privacy_policy')}</Link>
                            <Link href="/terms" className="hover:text-emerald-950 hover:underline decoration-emerald-500/30 underline-offset-4 transition-all">{t('landing.terms_of_service')}</Link>
                            ...
                            <Link href="/contact" className="hover:text-emerald-950 hover:underline decoration-emerald-500/30 underline-offset-4 transition-all">{t('landing.footer_contact')}</Link>
                        </div>
                    </div>
